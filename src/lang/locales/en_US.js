module.exports = {
   ...
   "sidebar.users": "Users",
   "sidebar.addUser": "Add New User",
   "sidebar.blog": "Blog Post",
   "sidebar.blogpost": "Blog Post",
   "sidebar.blogPost": "Blog Post",
   "sidebar.addBlog": "Add Blog Post",
   "sidebar.editBlog": "Edit Blog Post",
   "sidebar.addBlogPost": "Add Blog Post",
   "sidebar.editBlogPost": "Edit Blog Post",
   "sidebar.detailBlogPost": "Blog Post Detail",
   "sidebar.programFeedback": "Program Feedback",
   "sidebar.support_feedback": "Feedback and Support",
   "sidebar.pages": "Pages",
   "sidebar.addPage": "Add Page",
   "sidebar.editPage": "Edit Page",
   "sidebar.settings": "Settings",
   "sidebar.program": "Program",
   "sidebar.addProgram": "Add Program",
   "sidebar.editProgram": "Edit Program",
   "sidebar.detailProgram": "Program Detail",
   "sidebar.appointement": "Appointment Detail",
   "sidebar.appoinmentdetails": "Appointment Detail",
   "sidebar.appointmentProgram": "Appointment Detail",
   "sidebar.appointementDetail": "Appointment Detail",
   "sidebar.addAppointement": "Add Appointment",
   "sidebar.editAppointement": "Edit Appointment",
   "sidebar.bulletin": "Bulletin",
   "sidebar.addBulletin": "Add Bulletin",
   "sidebar.editBulletin": "Edit Bulletin",
   "sidebar.detailBulletin": "Bulletin Detail",
   "sidebar.ratings": "Ratings",
   "sidebar.load": "Loads",
   "sidebar.addLoad": "Add Load",
   "sidebar.editLoad": "Edit Load",
   "sidebar.loadDetails": "Load details",
   "sidebar.app": "App",
   "sidebar.news": "News",
