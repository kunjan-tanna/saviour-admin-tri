                                        ...
                                        <Form className='addCarrierForm' >
                                            <div className='formWrapper'>
                                                ...
                                                <div>
                                                    ...
                                                    <span className='profileTxt'>&nbsp;{blogPostData.title}</span>
                                                </div>
                                                <div>
                                                    <Label htmlFor="author_name"><b>Author Name: </b></Label>
                                                    <span className='profileTxt'>&nbsp;{blogPostData.author_name}</span>
                                                </div>
                                                <div>
                                                    <Label htmlFor="description"><b>Description : </b></Label>
                                                    <span className='profileTxt'>&nbsp;{blogPostData.description}</span>
                                                </div>
                                                <div>
                                                    <Label htmlFor="dot"><b>Image : </b></Label>
